...
public abstract class AbstractComputation implements Computation {
    ...
    public void setPolicy(ComputationPolicy policy) {
        this.policy = policy;
    }
     ...
     * @since 10.3
     */
    public void processRetry(ComputationContextImpl context, Throwable failure) {
     ...
     * @since 10.3
     */
    public void processFailure(ComputationContextImpl context, Throwable failure) {
